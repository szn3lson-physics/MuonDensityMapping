...
const std::string FILE1_DETAILS = "D:\\MuonDensityMapping\\bin\\simulation\\simulation_output\\sim_details_C.txt";
const std::string FILE2_MC_SUMMARY = "D:\\MuonDensityMapping\\bin\\simulation\\simulation_output\\sim_summary_C.txt";
const std::string FILE3_MC_EVENTS = "D:\\MuonDensityMapping\\bin\\simulation\\simulation_output\\sim_root_C.txt";

const double PIXEL_SIZE = 0.13333;  

const double DETECTOR_X = 911.0;      
const double DETECTOR_Y = 1159.0;     

const double MAX_RADIUS_M = 40.0;   
