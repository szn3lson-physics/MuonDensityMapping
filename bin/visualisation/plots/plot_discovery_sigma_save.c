...
#include <vector>
    ...
    //const char* INPUT_FILE = "/home/kacper/MuonDensityMapping/bin/data_analysis/output/selected_rot_series/series_400.txt";
    //const char* INPUT_BACKGROUND = "/home/kacper/MuonDensityMapping/bin/simulation/simulation_output/400/bkg/30.00_metrow_hard.txt";
    //const char* INPUT_BACKGROUND = "/home/kacper/MuonDensityMapping/bin/simulation/simulation_output/400/bkg/30.00_metrow_exp.txt";
    //const char* INPUT_BACKGROUND = "/home/kacper/MuonDensityMapping/bin/simulation/simulation_output/400/bkg/30.00_metrow_gauss.txt";

    //const char* OUTPUT_PLOT = "/home/kacper/MuonDensityMapping/figures/400_fit_instant_distance_chi2.pdf";
    //const char* OUTPUT_PLOT = "/home/kacper/MuonDensityMapping/figures/400_fit_exp_distance_chi2.pdf";
    //const char* OUTPUT_PLOT = "/home/kacper/MuonDensityMapping/figures/400_fit_gauss_distance_chi2.pdf";

    //const char* INPUT_FILE = "/home/kacper/MuonDensityMapping/bin/data_analysis/output/selected_rot_series/series_900.txt";
    //const char* INPUT_BACKGROUND = "/home/kacper/MuonDensityMapping/bin/simulation/simulation_output/900/bkg/48.00_metrow_hard.txt";
    //const char* INPUT_BACKGROUND = "/home/kacper/MuonDensityMapping/bin/simulation/simulation_output/900/bkg/60.00_metrow_exp.txt";
    //const char* INPUT_BACKGROUND = "/home/kacper/MuonDensityMapping/bin/simulation/simulation_output/900/bkg/54.00_metrow_gauss.txt";

    const char* INPUT_FILE = "/home/kacper/MuonDensityMapping/bin/simulation/simulation_output/MC_single/det_1_with_hole.txt";
    const char* INPUT_BACKGROUND = "/home/kacper/MuonDensityMapping/bin/simulation/simulation_output/MC_single/det_1_without_hole.txt";

    //const char* OUTPUT_PLOT = "/home/kacper/MuonDensityMapping/figures/900_fit_instant_distance_chi2.pdf";
    //const char* OUTPUT_PLOT = "/home/kacper/MuonDensityMapping/figures/900_fit_exp_distance_chi2.pdf";
    //const char* OUTPUT_PLOT = "/home/kacper/MuonDensityMapping/figures/900_fit_gauss_distance_chi2.pdf";
    
    const char* OUTPUT_PLOT = "/home/kacper/MuonDensityMapping/figures/residua_detektor_1.pdf";
    
    // Nowy plik wyjściowy dla danych resztkowych (sigm)
    const char* OUTPUT_TEXT = "/home/kacper/MuonDensityMapping/bin/visualisation/output/residua_detektor_1.txt";

void plot_discovery_sigma_save() {
    ...
    // --- Wektory akumulacji danych (DOKŁADNIE TAK JAK W HIS1) ---
    ...
    if (f_dat_txt.is_open()) {
        std::getline(f_dat_txt, line); 
        while (std::getline(f_dat_txt, line)) {
            if (line.empty()) continue;
            std::stringstream ss(line);
            std::string item;
            int angle; double time_min; double counts;
    ...
    // --- 2. LOAD BACKGROUND MODEL ---
    std::ifstream f_bkg_txt(INPUT_BACKGROUND);
    if (f_bkg_txt.is_open()) {
        std::getline(f_bkg_txt, line); // Skip header
        int ang; double theo_counts;
        while (f_bkg_txt >> ang >> theo_counts) {
        ...
        std::cerr << "[ERROR] Cannot open background model file." << std::endl;
        return;
    }

    // --- 3. CALCULATE GLOBAL SIGMA (Dokładnie jak w his1) ---
    ...
    if (f_out_txt.is_open()) {
        // Nagłówek zgodnie z prośbą, z dodanym czasem na drugiej pozycji
    ...
    for(int i = 0; i < n_bins; ++i) {
        // Wyliczamy dolną krawędź binu jako reprezentację kąta (np. 0, 5, 10...)
        double current_angle = i * bin_width_deg; 
        ...
        if (sum_time_min[i] > 0) {
            ...
            // Wyliczanie sigmy przy użyciu globalnego błędu
            ...
            // Zapis samych zer dla binów, w których nie było czasu pomiaru
            if (f_out_txt.is_open()) {
