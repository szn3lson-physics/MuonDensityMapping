...
void plot_bin() {
    ...
    // ================= USER SETTINGS =================
    const char* FILE_PATH  = "D:\\MuonDensityMapping\\bin\\simulation\\simulation_output\\bin_analysis.txt";
    const char* OUTPUT_PLOT = "D:\\MuonDensityMapping\\figures\\bin_fit.pdf";
