...
int main (){
    ...
    const int START = 8;   // from which data file to start
    ...
    for (int i = START; i <= END; ++i) {
        ...
        string angle_path =     "D:/MuonDensityMapping/output/dane_" + to_string(i);
        string raw_path =       "D:/MuonDensityMapping/output/dane_" + to_string(i) + "/raw/";
        string processed_path = "D:/MuonDensityMapping/output/dane_" + to_string(i) + "/processed/";
        //this folder doesnt have to exist so first to check
        folder_managment(angle_path);
        folder_managment(raw_path);
        folder_managment(processed_path);

        // 1. excavate only nessessery data
        output_data(data_file, angle_path + "/angles_" + to_string(i) + ".txt");

        // 2. take excaveted data and assign to each line angles for which detection was done
        time_to_angle(angle_path + "/angles_" + to_string(i) + ".txt");
        ...
        coindidence_3 (angle_path + "/angles_" + to_string(i) + ".txt", raw_path + "coin_" + to_string(i) + "_3.txt");
        filesystem::copy_file(raw_path + "coin_" + to_string(i) + "_3.txt", processed_path + "coin_" + to_string(i) + "_3.txt", filesystem::copy_options::overwrite_existing);
        coindidence_3f(angle_path + "/angles_" + to_string(i) + ".txt", raw_path + "coin_" + to_string(i) + "_3f.txt");
        filesystem::copy_file(raw_path + "coin_" + to_string(i) + "_3f.txt", processed_path + "coin_" + to_string(i) + "_3f.txt", filesystem::copy_options::overwrite_existing);
        coindidence_4 (angle_path + "/angles_" + to_string(i) + ".txt", raw_path + "coin_" + to_string(i) + "_4.txt");
        filesystem::copy_file(raw_path + "coin_" + to_string(i) + "_4.txt", processed_path + "coin_" + to_string(i) + "_4.txt", filesystem::copy_options::overwrite_existing);
        coindidence_3_4 (angle_path + "/angles_" + to_string(i) + ".txt", raw_path + "coin_" + to_string(i) + "_34.txt");
        filesystem::copy_file(raw_path + "coin_" + to_string(i) + "_34.txt", processed_path + "coin_" + to_string(i) + "_34.txt", filesystem::copy_options::overwrite_existing);
        coindidence_3_4f(angle_path + "/angles_" + to_string(i) + ".txt", raw_path + "coin_" + to_string(i) + "_34f.txt");
        filesystem::copy_file(raw_path + "coin_" + to_string(i) + "_34f.txt", processed_path + "coin_" + to_string(i) + "_34f.txt", filesystem::copy_options::overwrite_existing);
    }
